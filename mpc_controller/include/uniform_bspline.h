...
{
  // An implementation of non-uniform B-spline with different dimensions//不同维数非均匀b样条的实现
  // It also represents uniform B-spline which is a special case of non-uniform//它也表示均匀b样条，这是非均匀的一种特殊情况
  ...
  private:
    ...
    int p_, n_, m_;     // p degree 次数, n+1 control points, m = n+p+1
