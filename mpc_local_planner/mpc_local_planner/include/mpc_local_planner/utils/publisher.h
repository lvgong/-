...
class Publisher
{
 ...
 private:
    ...
    ros::Publisher _local_plan_pub;//用于以“ local_plan ”的话题发布局部规划
    ros::Publisher _global_plan_pub;//用于以“ global_plan ”的话题发布全局规划
    ros::Publisher _mpc_marker_pub;//用于以“ mpc_markers ”的话题以模型的形式发布mpc规划结果
};
