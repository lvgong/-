...
namespace chibot::topologyplanning {
    ...
    constexpr static const char* LMPC_NODE_NAME = "hybrid_astar_Bspline_LMPC";
    constexpr static const char* NMPC_NODE_NAME = "hybrid_astar_Bspline_NMPC";
...
class HybridAstarBsplineNMPC {
    public:
        HybridAstarBsplineNMPC();
        ~HybridAstarBsplineNMPC() = default;
        void init();
        void run();
        void stop();
